                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('painel-save-post') }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="title" class="col-12 col-md-4 col-form-label text-md-right">Título:</label>
                        ...
                        <div class="form-group row">
                            <label for="imagem" class="col-12 col-md-4 col-form-label text-md-right">Imagem:</label>
                            <div class="col-12 col-md-8">
                        ...
                        <div class="form-group row">
                            <label for="resumo" class="col-12 col-md-4 col-form-label text-md-right">Resumo:</label>
                            <div class="col-12 col-md-8">
                        ...
                        <div class="form-group row">
                            <label for="texto" class="col-12 col-md-4 col-form-label text-md-right">Texto:</label>
                            <div class="col-12 col-md-8">
                        ...
                        <div class="form-group row">
                            <label for="status" class="col-12 col-md-4 col-form-label text-md-right">Status:</label>
                            <div class="col-12 col-md-8">
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-4 col-form-label text-md-right">Categorias:</label>

                            <div class="col-12 col-md-8">
                                @foreach ($categories as $category)
                                    <p>
                                        <input type="checkbox" id="category-{{$category->id}}" name="categories[]" value="{{$category->id}}" {{ isset($post) && $post->categories->contains('id', $category->id) ? 'checked' : '' }}>
                                        <label for="category-{{$category->id}}">{{$category->nome}}</label>
                                    </p>
                                @endforeach
                            </div>
                        </div>
