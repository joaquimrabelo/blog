                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('painel-save-group') }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="nome" class="col-12 col-md-4 col-form-label text-md-right">Nome:</label>
                        ...
                        <div class="form-group row">
                            <label for="descricao" class="col-12 col-md-4 col-form-label text-md-right">Descrição:</label>
                            <div class="col-12 col-md-8">
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-4 col-form-label text-md-right">Permissões de acesso:</label>
                            ...
                            <div class="col-12 col-md-8">
                                @foreach ($arrPermissions as $permission)
                                    <p>
                                        ...
                                        <label for="permission-{{$permission->id}}">{{$permission->descricao}}</label>
                                    </p>
                                @endforeach
                            </div>
                        </div>
